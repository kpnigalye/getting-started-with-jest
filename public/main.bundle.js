    ...
    AddPaymentComponent.prototype.onAddPaymentSubmit = function () {
        ...
        this.feesdetailsService.updateFeesDetails(this.fees).subscribe(function (feesData) {
            if (feesData.success) {
                ...
                _this.paymentRecord.paymentMonthNo = new Date(_this.paymentDate).getMonth(),
...
var StudentProfileComponent = (function () {
            ...
            this.feesdetailsService.updateFeesDetails(this.fees).subscribe(function (feesData) {
                if (feesData.success) {
                    ...
                    var paymentDetail = {
                        ...
                        paymentMonthNo: new Date(_this.paymentDate).getMonth(),
                        amount: _this.amount,
                        modeOfPayment: "",
                        bankName: "",
                        branch: "",
    ...
    StudentProfileComponent.prototype.changeToAddState = function () {
        this.state = true;
        this.amount = "";
        this.paymentDate = "";
    };
        ...
        if (newTotalInstallmentAmount <= Number(this.fees.totalFeesToPay)) {
            ...
            this.feesdetailsService.updateFeesDetails(this.fees).subscribe(function (feesData) {
                if (feesData.success) {
                    ...
                    _this.paymentHistory[_this.index].paymentMonthNo = new Date(_this.paymentDate).getMonth();
