...
var appRoutes = [
    ...
    { pathMatch: 'full', path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_8__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'studentprofile/:id', component: __WEBPACK_IMPORTED_MODULE_16__components_student_profile_student_profile_component__["a" /* StudentProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'addstudent/:id', component: __WEBPACK_IMPORTED_MODULE_9__components_add_student_add_student_component__["a" /* AddStudentComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'updatestudent/:id', component: __WEBPACK_IMPORTED_MODULE_10__components_update_student_update_student_component__["a" /* UpdateStudentComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'addPayment/:id', component: __WEBPACK_IMPORTED_MODULE_12__components_add_payment_add_payment_component__["a" /* AddPaymentComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'paymenthistory/:id', component: __WEBPACK_IMPORTED_MODULE_13__components_payment_history_payment_history_component__["a" /* PaymentHistoryComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    ...
    { pathMatch: 'full', path: 'redirect/:message', component: __WEBPACK_IMPORTED_MODULE_15__components_redirect_redirect_component__["a" /* RedirectComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'studentslisting', component: __WEBPACK_IMPORTED_MODULE_11__components_students_listing_students_listing_component__["a" /* StudentsListingComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
    { pathMatch: 'full', path: 'userprofile', component: __WEBPACK_IMPORTED_MODULE_19__components_user_profile_user_profile_component__["a" /* UserProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */]] },
];
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_20__guards_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_17__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_18__services_validate_service__["a" /* ValidateService */]],
...
var LoginComponent = (function () {
    function LoginComponent(router, authService, validateService) {
        this.router = router;
...
var StudentsListingComponent = (function () {
    function StudentsListingComponent() {
    }
